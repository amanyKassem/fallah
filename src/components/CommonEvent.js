        ...
        return (
            ...
            <Container style={Styles.container}>
                <Header style={[Styles.altHeaader , {paddingTop:Platform.OS === 'ios' ?0: 'auto' , paddingBottom: Platform.OS === 'ios' ?25:0} ]} noShadow>
                    ...
                    <Text style={{ color: '#fff', textAlign: 'center', fontSize: 20 , fontFamily:'RegularFont' }}>{i18n.t('commonEvents')}</Text>
                    </Body>
                ...
                <Content style={Styles.content}>
                    ...
                    <View style={Styles.parentView}>
                        ...
                        <Image source={require('../../assets/images/most_seen_events.png')}  style={Styles.headphone} resizeMode={'contain'} />
                        <FlatList
...
export default connect(mapStateToProps, {})(CommonEvent);