...
class Organizations extends Component {
    ...
    static navigationOptions = () => ({
        drawerLabel: i18n.t('organizations') ,
        drawerIcon: (<Image source={require('../../assets/images/note.png')} style={{ height: 20, width: 20 , top:3 }} resizeMode={'contain'} /> )
    })

    componentWillMount(){
        axios({
            url: CONST.url + 'organizations_events',
            method: 'POST',
    ...
    filter = () => {
        ...
        axios({
            ...
            method: 'POST',
            data: { lang: this.props.lang ,city_id:this.state.selectedCity , org_id : this.state.selectedOrganizations , date: this.state.date , price : this.state.value}
        }).then(response => {
            this.setState({
        ...
        return (
            ...
            <Container style={Styles.container}>
                <Header style={[Styles.altHeaader , {paddingTop:Platform.OS === 'ios' ?0: 'auto' , paddingBottom: Platform.OS === 'ios' ?25:0} ]} noShadow>
                    ...
                    <Text style={{ color: '#fff', textAlign: 'center', fontSize: 20 , fontFamily:'RegularFont' }}>{i18n.t('organizations')}</Text>
                    </Body>
                ...
                <Content style={Styles.content}>
                    ...
                    <View style={Styles.parentView}>
                        ...
                        {/*<Image source={require('../../assets/images/note.png')}  style={Styles.headphone} resizeMode={'contain'} />*/}
                        <FlatList
